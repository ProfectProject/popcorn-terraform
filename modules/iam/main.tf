  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = [
          "arn:aws:logs:${var.region}:${var.account_id}:log-group:/aws/ecs/${var.project_name}/*"
        ]
      },
      {
        Effect = "Allow"
        ...
        Resource = [
          "arn:aws:kafka:${var.region}:${var.account_id}:cluster/${var.project_name}-msk-serverless/*"
        ]
      },
      {
        Effect = "Allow"
        ...
        Resource = [
          "arn:aws:kafka:${var.region}:${var.account_id}:topic/${var.project_name}-msk-serverless/*"
        ]
      },
      {
        Effect = "Allow"
        ...
        Resource = [
          "arn:aws:kafka:${var.region}:${var.account_id}:group/${var.project_name}-msk-serverless/*"
        ]
      }
    ]
  })
